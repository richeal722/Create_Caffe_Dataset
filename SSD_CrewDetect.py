...
# Purpose:     Label Tool for Deep Learning (SSD)
# Author:      Zhangrui Modify
# Created:     12/19/2016
...
classLabels=['person', 'laptop', 'monitor', 'handrail']
      ...
      # set up output dir
        ...
        for label in labeledPicList:
            ...
            if '0\n' == data.read():
                ...
                continue
            data.close()
            picture = label.replace('Labels', 'JPEGImages').replace('.txt', '.jpg')
...
##                    print tmp
    ...
    def selectlaptop(self):
        self.currentClass = 'laptop'    
        self.classbox.delete(0,END)    
        self.classbox.insert(0, 'laptop')
        self.classbox.itemconfig(0,fg = COLORS[0])
    
    def selectmonitor(self):
        self.currentClass = 'monitor'    
        self.classbox.delete(0,END)    
        self.classbox.insert(0, 'monitor')
        self.classbox.itemconfig(0,fg = COLORS[0])
        
    def selecthandrail(self):
        self.currentClass = 'handrail'    
        self.classbox.delete(0,END)    
        self.classbox.insert(0, 'handrail')
        self.classbox.itemconfig(0,fg = COLORS[0])
